  ...
  return (
    <div className={`premium-page${active ? ' premium-page-active' : ''}`}>
      ...
      <p className="premium-fineprint">
        Денег никто не берёт, карту вводить некуда — кнопка просто включает золотой режим. Эффект на кубы настоящий и
        виден всей партии: подкрученные броски помечаются ✨, а иконка светится золотом. Выключается той же кнопкой.
      </p>
    </div>
  )
}
